...
# ✅ PERBAIKAN: Fungsi get_db() yang aman
def get_db():
...
# ✅ PERBAIKAN: Rute /api/tanya yang aman dan tidak error
@app.post("/api/tanya")
...
Masalahnya setelah saya deploy, Alina jadi tidak dapat terhubung dengan API-nya. Untuk mengatasi sementara, akhirnya saya ubah kodenya jadi seperti ini : 
from fastapi import FastAPI, Request, HTTPException, status, Depends
from fastapi.middleware.cors import CORSMiddleware
from fastapi.staticfiles import StaticFiles
from fastapi.responses import FileResponse, JSONResponse, RedirectResponse
